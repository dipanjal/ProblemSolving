...
// Tabulation | Space Optimized| Bottom Up | Dynamic Programming
...
public class SolutionTabOptimized {
    ...
    public int minCostClimbingStairs(int[] cost) {
        ...
        // base cases
        int prev = 0; // we can start from index 0 with no cost
        int curr = 0; // we can also start from index 1 with no cost
